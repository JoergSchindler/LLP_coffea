...
def writeYields(cut = None,muon=True,outf="yields.json",debug=True,shifts=None, tauSignals=False,unblind=False,useOOT=True,mixing=True):
    ...
    if muon:
        ...
        if tauSignals:
            signals  = loadhist(path_prefix+"HNL_histograms_Jan9_tau_signals_mu_2018.pickle",True,cut,debug,lumi,
        ...
        if tauSignals:
            ...
            signals = loadhist( path_prefix+"HNL_histograms_Jan4_ele_signals_2018.pickle",False,cut,debug,lumi,
    ...
    if mixing:
        ...
        writeMixingYields(data,muon,outf)
    return 
            ...
            for ftau in mixing_points:
                ...
                for name,signal in data.items():
                        ...
                        if "bkg" in name:
                            ...
                            mixed_sample_name = "HNL_mixed-fe{}-fmu{}-ftau{}_".format(fe,fmu,ftau).replace(".","p")+name[name.find("mHNL"):]
